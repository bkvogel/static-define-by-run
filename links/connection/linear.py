...
# This is the only change I made to the existing Chainer Link class. I only
# changed the import to cause it to use a different linear function that I wrote:
